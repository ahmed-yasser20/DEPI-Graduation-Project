...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260708100619_UpdateOrdersPaymentAndOrderProducts")]
    partial class UpdateOrdersPaymentAndOrderProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Payment", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("ECommerce.Domain.Entities.Payment", "OId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
