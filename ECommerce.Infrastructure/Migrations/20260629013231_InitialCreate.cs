        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customer_Shopping_Cart_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart_Items", x => x.CIId);
                    table.ForeignKey(
                        name: "FK_Cart_Items_Product_PId",
                        column: x => x.PId,
                        principalTable: "Product",
                        principalColumn: "PId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cart_Items_Shopping_Cart_CartId",
                        column: x => x.CartId,
                        principalTable: "Shopping_Cart",
                        principalColumn: "CartId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_Products", x => x.OPId);
                    table.ForeignKey(
                        name: "FK_Order_Products_Order_OId",
                        column: x => x.OId,
                        principalTable: "Order",
                        principalColumn: "OId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_Products_Product_PId",
                        column: x => x.PId,
                        principalTable: "Product",
                        principalColumn: "PId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_Products_OId",
                table: "Order_Products",
                column: "OId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_Products_PId",
                table: "Order_Products",
                column: "PId");
